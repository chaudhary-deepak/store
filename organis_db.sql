...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Mar 26, 2023 at 12:49 PM
...
DROP TABLE IF EXISTS `lankeyvalues`;
CREATE TABLE IF NOT EXISTS `lankeyvalues` (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8666 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `media_options` (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `media_settings` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `media_settings_media_type_unique` (`media_type`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
DROP TABLE IF EXISTS `menu_childs`;
CREATE TABLE IF NOT EXISTS `menu_childs` (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
  `menu_id` int(11) DEFAULT NULL,
  `menu_parent_id` int(11) DEFAULT NULL,
...
DROP TABLE IF EXISTS `offer_ads`;
CREATE TABLE IF NOT EXISTS `offer_ads` (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `products` (
  ...
  `title` text COLLATE utf8mb4_unicode_ci,
  `slug` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `f_thumbnail` text COLLATE utf8mb4_unicode_ci,
  `short_desc` text COLLATE utf8mb4_unicode_ci,
  `description` text COLLATE utf8mb4_unicode_ci,
  `extra_desc` text COLLATE utf8mb4_unicode_ci,
  ...
  `variation_color` text COLLATE utf8mb4_unicode_ci,
  `variation_size` text COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE IF NOT EXISTS `pro_categories` (
  ...
  `slug` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `thumbnail` text COLLATE utf8mb4_unicode_ci,
  `subheader_image` text COLLATE utf8mb4_unicode_ci,
  `description` text COLLATE utf8mb4_unicode_ci,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `pro_categories_slug_unique` (`slug`)
...
DROP TABLE IF EXISTS `section_manages`;
CREATE TABLE IF NOT EXISTS `section_manages` (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `subscribers` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `subscribers_email_address_unique` (`email_address`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `tp_options` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `tp_options_option_name_unique` (`option_name`)
...
(151, 'vipc', '{\"bactive\":1,\"resetkey\":1}', '2022-09-09 04:20:27', '2022-09-09 04:20:27');
...
CREATE TABLE IF NOT EXISTS `tp_status` (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
  `status` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `tp_status_status_unique` (`status`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
DROP TABLE IF EXISTS `withdrawal_images`;
CREATE TABLE IF NOT EXISTS `withdrawal_images` (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
